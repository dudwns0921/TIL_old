...
개발자에 따라 만들 수도, 만들지 않을 수도 있음

사용자 정의 함수 부분은 도입부와 main() 함수 부분 사이로 들어갈 수도 있음
...
- 설명문
  ...
  - 여러 줄에 걸친 설명문을 넣기 위해서는 /* */를 사용
  - 한 줄짜리 설명문을 넣기 위해서는 보통 // 사용
...
- C언어의 문법상 잘못된 경우 에러 메시지를 출력
- 즉, C언어의 문법에 맞지 않는 형식 사용이나 반드시 필요한 지정이 빠진 경우 등 발생
- 에러 메시지를 확인해 반드시 수정해야 함
